...
# this is expecting two arguements
  def test_pets_sold
    sold = pets_sold(@pet_shop)
    assert_equal(0, sold)
  end

#increase the amount pets sold - takes two arguements
#increase is the act
...
# this is testing the total pets within the pets array
# takes two arguemnts
...
#this test is looking for the amount of times British Shorthair is in the array by using the .count function
  def test_all_pets_by_breed__found
    pets = pets_by_breed(@pet_shop, "British Shorthair")
    assert_equal(2, pets.count)
  end

  #this test is looking for the
